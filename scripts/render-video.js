...
(async () => {
  ...
  if (hasReady) {
    // Second safety net: proactively reset animation time to zero — handles HTML that
    // doesn't strictly follow the starter tick template (e.g. using performance.now()
    // for lastTick causes font-load time to be counted in the first-frame dt).
